                    ...
                    <div className="flex flex-col md:flex-row gap-4 justify-between items-center">
                        ...
                        <div className="hidden md:flex gap-2 text-sm overflow-x-auto max-w-full pb-2 md:pb-0 scrollbar-hide">
                            <button
                                ...
                                className={`flex items-center gap-2 px-4 py-2 rounded-full transition-colors whitespace-nowrap ${activeCategory === "all" ? "bg-primary text-white font-bold" : "bg-gray-100 text-gray-600 hover:bg-gray-200"
                                    }`}
                            >
                                All
                            </button>
                            {catalogueData.map(cat => (
                                <button
                                    ...
                                    className={`flex items-center gap-2 px-4 py-2 rounded-full transition-colors whitespace-nowrap ${activeCategory === cat.id ? "bg-primary text-white font-bold" : "bg-gray-100 text-gray-600 hover:bg-gray-200"
                                        }`}
                                >
                                    <span>{cat.icon}</span>
                                    {cat.title}
