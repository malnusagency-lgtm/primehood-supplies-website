...
export default function Button({
    ...
    const baseStyles =
        "inline-flex items-center justify-center gap-2 px-8 py-4 font-heading font-bold uppercase tracking-wider rounded-full transition-all duration-300 relative overflow-hidden group cursor-pointer";

    const variants = {
        primary:
            "bg-gradient-to-r from-primary to-accent text-white shadow-[0_0_30px_rgba(0,212,255,0.3)] hover:shadow-[0_0_40px_rgba(0,212,255,0.5)] hover:-translate-y-1 border-none",
        secondary:
